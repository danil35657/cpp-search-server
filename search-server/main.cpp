...
template <typename It> // 1.19.9 вывод страницами страницами
class Paginator {
...
ostream& operator<<(ostream& output, Document document) { // 1.19.9 вывод страницами
	output << "{ "s
...
template <typename Element> // 1.19.9 вывод страницами
...
template <typename Container> // 1.19.9 вывод страницами
